...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel(
				"<html>Which is not a real fruit? <br> A: Catfruit <br> B: Dogfruit <br> C: Hamsterfruit</html>");
		question3 = new JLabel("<html>Which is not a real fruit? <br> A: hat <br> B: orange <br> C: Orange</html>");
		question4 = new JLabel(
				"<html>Which is not a real fruit? <br> A: blueberry <br> B: blueberry <br> C: Blueberry</html>");
	}
...
//		 questions must be in reverse order from top to bottom to work properly
		if (question4.isShowing()) {
			if (keyCode == A) {
				correct();
				JOptionPane.showMessageDialog(null, "Congratulations! You answered all 5 questions correctly!");
			} else {
				incorrect();
			}
		}
